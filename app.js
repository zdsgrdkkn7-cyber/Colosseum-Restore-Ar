...
document.addEventListener("DOMContentLoaded",()=>{$("#fecha").value=new Date().toISOString().slice(0,10);buildRatings();addPanelCorners();try{const d=JSON.parse(localStorage.getItem("cr_draft")||"null");if(d)apply(d)}catch(e){}fitMobile();if("serviceWorker" in navigator)navigator.serviceWorker.register("./sw.js").catch(()=>{})});
