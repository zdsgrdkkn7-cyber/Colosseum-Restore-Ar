...
async function generatePdf(){
  ...
  try{
    [hoohSprite,celebiSprite]=await Promise.all([
  ...
  // Sprites a ambos lados del título, manteniendo libre el área de Cliente/Fecha e IG.
  drawPdfSprite(doc,hoohSprite,43,14,18);
  drawPdfSprite(doc,celebiSprite,149,14,18);
  ...
  doc.setTextColor(...amber);
  doc.text("IG: @colosseum.ar",196,19,{align:"right"});
  ...
  doc.setTextColor(...cream);
  doc.setFontSize(7.2);
  drawWrappedText(doc,f.observaciones,116,546,80,4.0,7);
