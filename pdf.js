...
async function generatePdf(){
  ...
  doc.setTextColor(...amber);
  doc.text("IG: @colosseum.ar",184,20,{align:"right"});
  ...
  const entries=[
    ["Carta",f.carta,14,65,70],["Numero",f.numero,112,65,70],
    ["Set",f.set,14,73,70],["Version",f.version,112,73,70],
    ["Estado",f.estado,14,81,48],["Precio",f.precio,72,81,46],
    ["Idioma",f.idioma,132,81,58]
  ];
