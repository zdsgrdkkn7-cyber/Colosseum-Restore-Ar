...
async function generatePdf(){
  ...
  // Resultado separado para frente y dorso.
  doc.setFont("courier","bold");
  doc.setFontSize(6.8);
  doc.setTextColor(...amber);
  ...
  doc.setFontSize(16);
  doc.setTextColor(...cream);
  doc.text((pdfSafeText(f.resultadoFrente)||"—").toUpperCase(),135,533,{align:"center"});
  doc.text((pdfSafeText(f.resultadoDorso)||"—").toUpperCase(),171,533,{align:"center"});
  ...
  // Celebi remains clear of both grade fields and sits beside the notes.
  drawPdfSprite(doc,celebiSprite,181,550,15);
